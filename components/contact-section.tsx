...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-muted/30 dark:bg-muted/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Whether you have a question about a project, want to start a new collaboration, or just want to say hi,
